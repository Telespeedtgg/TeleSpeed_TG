<?php
ob_start();
define('API_KEY','169159771:AAEKzJuI6P-e9pTFG5bleinccrcyvSEfHgg');
$admin = "146480433";
...
".$jsu;
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'mohamad','url'=>'https://telegram.me/POKER_SOFT']
        ],
        [
...
bot('sendMessage',[
      'chat_id'=>$chat_id,
      'text'=>"به گروه خوش اومدی کار من اینه که میتونم کسانی که متنی رو ادیت میکنن رو بفهمم😆 "
    ]);
}
